...
//             resultDiv.innerHTML = "API key not found. Please set your API key key in the extension options. ";
//             return;
//         }
...
//                     } catch (error) {
//                         resultDiv.innerText = "Gemini error: " + error.message;
//                     }
//                 }
//             );
//         });
...
//     const max = 20000;
//     const truncatedText = text.length > max ? text.substring(0, max) + "..." : text;
